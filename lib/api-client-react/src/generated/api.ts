...
export const getGetAiAdviceUrl = () => {
  return `/api/ai/advise`;
};

export const getAiAdvice = async (
  aiAdviceInput: AiAdviceInput,
  options?: RequestInit,
): Promise<AiAdviceResult> => {
  return customFetch<AiAdviceResult>(getGetAiAdviceUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(aiAdviceInput),
  });
};
...
export type GetAiAdviceMutationResult = NonNullable<
  Awaited<ReturnType<typeof getAiAdvice>>
>;
export type GetAiAdviceMutationBody = BodyType<AiAdviceInput>;
